...
const slides = [
  ...
  { id: 's2', src: '/images/Slider2.png', alt: 'Velocidad', title: 'Financiamiento a tu medida', desc: 'Créditos con tasas competitivas', ctaLabel: 'Simular crédito', ctaHref: '/financiamiento' },
